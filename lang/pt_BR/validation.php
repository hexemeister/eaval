...
return [
    ...
    'required_without_all' => 'Informe ao menos um dos campos: :values.',
    ...
    'custom' => [
        'doi'     => ['required_without_all' => 'Informe ao menos um dos campos: DOI, Link ou ISBN.'],
        'link'    => ['required_without_all' => 'Informe ao menos um dos campos: DOI, Link ou ISBN.'],
        'isbn'    => ['required_without_all' => 'Informe ao menos um dos campos: DOI, Link ou ISBN.'],
        'autores' => ['min' => 'É obrigatório informar ao menos um autor.'],
    ],
    ...
    'attributes' => [
        ...
        'link'                    => 'link',
        'resumo'                  => 'resumo',
        'local_publicacao_id'     => 'local de publicação',
        'tipo_publicacao_id'      => 'tipo de publicação',
        'forma_apresentacao_id'   => 'forma de apresentação',
        'qualis_capes_id'         => 'Qualis CAPES',
        'tipo_instituicao_id'     => 'tipo de instituição',
        'turma_id'                => 'turma',
        'eixo_tematico_id'        => 'eixo temático',
        'segmento_educacional_id' => 'segmento educacional',
        'area_ids'                => 'áreas do conhecimento',
        'autores'                 => 'autores',
