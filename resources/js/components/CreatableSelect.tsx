...
export function CreatableSelect({
    ...
    function handleClickCreate() {
        ...
        setPendingValue(queryTrimmed);
        setConfirmOpen(true);
    }

    async function handleConfirmCreate() {
        if (!createRoute || creating) return;
                        ...
                        {onCreateClick && (
                            <CommandGroup>
                                <CommandItem
                                    ...
                                    onSelect={() => { setOpen(false); onCreateClick(); }}
                                    className="text-primary"
                                >
                                    <Plus className="mr-2 size-4" />
                                    {createLabel}
            ...
            <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Você está prestes a cadastrar um novo item:{' '}
