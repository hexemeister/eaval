...
const cadastroItems = [
  ...
  { title: 'Periódicos', href: '/admin/cadastros/periodicos' },
              ...
              <SidebarMenuSub>
                {cadastroItems.map((item) => (
                  <SidebarMenuSubItem key={item.href}>
                    <SidebarMenuSubButton asChild isActive={url.startsWith(item.href)} className="h-auto py-1 leading-snug whitespace-normal">
