...
Route::middleware(['auth', 'verified'])->prefix('admin')->group(function () {
    ...
    Route::post('autores/inline', [AdminPublicacoesController::class, 'criarAutorInline'])->name('admin.autores.inline');
    Route::get('palavras-chave/busca', [AdminPublicacoesController::class, 'buscarPalavrasChave'])->name('admin.palavras-chave.busca');
    Route::post('palavras-chave/inline', [AdminPublicacoesController::class, 'criarPalavraChaveInline'])->name('admin.palavras-chave.inline');
    Route::get('locais-publicacao/busca', [AdminLocalPublicacaoController::class, 'buscar'])->name('admin.locais-publicacao.busca');
    Route::post('locais-publicacao/inline', [AdminLocalPublicacaoController::class, 'storeInline'])->name('admin.locais-publicacao.store-inline');
    Route::match(['put', 'patch'], 'locais-publicacao/{id}/inline', [AdminLocalPublicacaoController::class, 'updateInline'])->name('admin.locais-publicacao.update-inline');
